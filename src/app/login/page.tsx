  ...
  return (
    <section className='flex items-center justify-center h-[80vh]'>
      <div className='flex flex-col items-center'>
        ...
        <form className='felx flex-col gap-2 w-[100%] max-w-[100%] '
        action="" method="post" autoComplete='off'>
          ...
          <button type='submit' 
          className='p-[10px] w-[100%] max-w-[100%] bg-green-800  text-gray-50 font-medium rounded-0'> Fazer Login</button>

          <fieldset className='border-t border-slate-50 mt-[10px]'>
            <legend className='mx-auto px-4 text-white text-1xl italic'> ou </legend>
            <div className='text-white pt-4 p-[10px] w-[100%] max-w-[100%] justify-center'>Acesse com o seu:</div>

          </fieldset>

          <button 
          
          type="button" className="p-[10px] w-[100%] max-w-[100%] justify-center text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
