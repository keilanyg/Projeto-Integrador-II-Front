    ...
    <div className={style.body}>
      ...
      <div className="sm:py-20">
        <div className="mx-auto max-w-8xl">
          <h2 className="text-3xl font-semibold text-center text-gray-900 mb-10" id="servicos" style={{ color: '#8C5C3D' }}>Serviços disponíveis</h2>
          <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3" style={{ color: '#8C5C3D' }}>
